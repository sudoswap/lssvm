...
abstract contract UsingETH is Configurable, RouterCaller {
    ...
    function swapNFTsForAnyNFTsThroughToken(
        ...
        return router.swapNFTsForAnyNFTsThroughETH{value: msg.value}(trade, minOutput, ethRecipient, nftRecipient, deadline);
    }
    ...
    function swapNFTsForSpecificNFTsThroughToken(
        ...
        return router.swapNFTsForSpecificNFTsThroughETH{value: msg.value}(trade, minOutput, ethRecipient, nftRecipient, deadline);
    }
