...
abstract contract RouterRobustBase is DSTest, ERC721Holder, Configurable, RouterCaller {
    ...
    // Test where pair 1 and pair 2 swap token for NFT succeed but pair 3 fails
