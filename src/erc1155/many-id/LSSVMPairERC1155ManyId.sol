...
/// @title LSSVMPairERC1155ManyId
/// @author boredGenius and 0xmons
/// @notice An NFT/Token pair for an ERC1155 NFT where each ID has a supply of 1 and
/// NFTs with different IDs are considered fungible.
abstract contract LSSVMPairERC1155ManyId is
