...
library LSSVMPairERC1155Cloner {
    /**
     ...
     */
    function cloneManyIdETHPair(
        address implementation,
        ILSSVMPairERC1155FactoryLike factory,
        ICurve bondingCurve,
        IERC1155 nft,
        uint8 poolType
     ...
     * accessed by the implementation contract.
     */
    function cloneSingleIdERC20Pair(
        address implementation,
        ILSSVMPairERC1155FactoryLike factory,
        ICurve bondingCurve,
        IERC1155 nft,
    ...
    /**
     * @notice Checks if a contract is a clone of a LSSVMPairERC1155ManyIdERC20.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param implementation the LSSVMPairERC1155ManyIdERC20 implementation contract
     * @param query the contract to check
     * @return result True if the contract is a clone, false otherwise
     */
    function isManyIdERC20PairClone(
        address factory,
        address implementation,
        address query
    ) internal view returns (bool result) {
    ...
    /**
     * @notice Checks if a contract is a clone of a LSSVMPairERC1155SingleIdETH.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param factory the factory that deployed the clone
     * @param implementation the LSSVMPairERC1155SingleIdETH implementation contract
     * @param query the contract to check
     * @return result True if the contract is a clone, false otherwise
     */
    function isSingleIdETHPairClone(
        address factory,
        address implementation,
        address query
    ) internal view returns (bool result) {
    ...
    /**
     * @notice Checks if a contract is a clone of a LSSVMPairERC1155SingleIdERC20.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param implementation the LSSVMPairERC1155SingleIdERC20 implementation contract
     * @param query the contract to check
     * @return result True if the contract is a clone, false otherwise
     */
    function isSingleIdERC20PairClone(
        address factory,
        address implementation,
        address query
    ) internal view returns (bool result) {
